    ...
    <body id="page-top">
		...
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
                ...
                <a class = "btn btn-success disabled"><span class = "badge"><?php echo $att['total']?></span> En Attente</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `users` NATURAL JOIN `chambre` WHERE `status` = 'En attente'") or die(mysqli_error());
